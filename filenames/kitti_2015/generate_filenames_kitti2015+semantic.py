...
def gen_kitti_2015():
    data_dir = '/root/dataset/kitti_2015'
    ...
    with open(train_file, 'w') as train_f, open(val_file, 'w') as val_f:
        ...
        for left_img in left_imgs:
            ...
            sem_path = left_img.replace(dir_name, 'semantic')
